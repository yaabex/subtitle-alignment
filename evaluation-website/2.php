<head>
    ...
    <?
        ...
        $nameEN = "data/" . $id . "/" . $id . ".1.en.txt";
        $namePT = "data/" . $id . "/" . $id . ".1.pt.txt";
    ?>
</head>
<body>
    <header>
    ...
    <center>
        <div id='instructions'>
            Seleciona <b>15 correspondências</b>, clicando nas frases em Inglês e nas suas correspondentes em Português.<br>
    ...
    <button id='next_btn' onclick='document.getElementById("results").submit()' disabled>Avançar</button> <span id='page_number'>2 de 4</span>
    <form method="post" action="3.php?id=<?=$id?>" id='results' style='display:none'></form>
</body>